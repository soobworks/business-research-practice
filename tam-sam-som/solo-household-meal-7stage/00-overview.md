...
> ⚠️ **주의**: "1인 식사 주문 참고시장 약 17.5조원"은 공식 통계가 아니라 2025 음식서비스 거래액 × 배민 1인 주문자 비중을 적용한 Top-down 참고 추정치다. 최종 가설이 다채널이므로 이 값을 최종 SAM으로 확정하지 않는다.
...
- 최종 가설이 배달·포장·편의점·HMR을 함께 보므로, 최종 SAM은 5단계 이후 채널별 이용빈도와 중복을 제거한 뒤 다시 산정해야 한다.
