...
>
> ⚠️ **이 문서는 아직 갱신 전이다.** [03-DOS매트릭스.md](./03-DOS매트릭스.md)가 "Pain별 MR"에서 "인물별 MR + SAM/SOM 이원화"로 재구성되면서 DOS 값이 전부 바뀌었다 — 아래 좌표는 재구성 **이전** 판의 DOS를 쓰고 있다. SAM 기준·SOM 기준 중 어느 쪽으로 다시 그릴지 정한 뒤 갱신해야 한다([03번 §8 다음 단계 3번](./03-DOS매트릭스.md) 참고).
