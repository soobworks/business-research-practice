...
> Top 5 원본: [KSF (기업 사례 포함)](./신규진입자-Top5-KSF-기업사례포함.md)
> 선행 분석: [Five Forces – 분석①](../01.porters-five-forces/분석①-위치기반-SNS.md) · [분석②](../01.porters-five-forces/분석②-수소전기승용차.md) · [Five Forces 비교](../01.porters-five-forces/비교분석-위치기반SNS-vs-수소전기승용차.md) · [가치사슬 비교](../02.value-chain/비교분석-위치기반SNS-vs-수소전기차.md)
...
> ⚠️ **핵심 포인트.** *'진입자 위협 높음'*이 *'진입하기 쉽다'*를 뜻하지 않고, *'진입자 위협 낮음'*이 *'진입이 불가능하다'*를 뜻하지 않는다. Five Forces의 진입 장벽 판정은 **분석자가 어떤 진입 지점을 상정했느냐에 종속**된다. ②의 장벽이 높게 나온 것은 [분석②의 "0. 분석 단위 설정"](../01.porters-five-forces/분석②-수소전기승용차.md)이 분석 주체를 "개인 소비자 대상 완성차 업체"로 못 박았기 때문이며, 층위를 상용차 플릿이나 소재 공급으로 바꾸면 판정도 바뀐다.
>
